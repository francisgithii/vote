...
{
window .location = 'http://www.francis.com/myleader/results_secgen.php' ;
}
...
print "<td align='left' valign='top' id='content'>";
print "<b>"."<font size='5' color='#333333' face='Consolas'>"."Secretary General"."</font>"."</b>"."<br><br>";
...
<a href='results_chairman.php' target="_blank">Next</a>
</body>