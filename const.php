...
<table >
		...
		<tr id="linkbar"><td >Chairperson</td><td>Sec General</a></td><td>Treasurer </a></td><td>Project Coordinator </a></td><td>Asst P.Coordinator </a></td><td>Asst Sec Gen </a></td><td background="bg1.jpg">Constitution </a></td></tr>
...
session_start();
if (!(isset($_SESSION['gatepass_const']) && $_SESSION['gatepass_const'] != '')) {
...
<form name="form1" method="GET" action="process_const.php">
<?php print "<b>"."<font size='5' color='#FF0000'>".$question."</font>"."</b>"; ?>
<br><br>
<table><tr><td valign='top'>
<img src="profile/const_new.jpg" width="150" height="170" align="center" class="pic">
<br><br>
...
<td valign='top'>
<img src="profile/const_old.jpg" width="150" height="170" align="center" class="pic">
<br><br>
