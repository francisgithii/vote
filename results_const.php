<html><head>
<title>Results Constitutions</title>
...
{
window .location = 'http://www.francis.com/myleader/results_const.php' ;
}
...
/*
print "<td align='left' valign='top' id='content'>";
print "<b>"."<font size='5' color='#333333' face='Consolas'>"."Assitant Sec Gen"."</font>"."</b>"."<br>";
print $qA_z."<br>"." ".$imgtagA_z." ".$percentA_z. "% "."   "."<br>votes"." ".$answerA_z."<br>"."<br>";
print $qB_z."<br>"." ".$imgtagB_z." ".$percentB_z. "% "."   "."<br>votes"." ".$answerB_z."<br>"."<br>";
print $qC_z."<br>"." ".$imgtagC_z." ".$percentC_z. "% "."   "."<br>votes"." ".$answerC_z."<br>"."<br>";
...
//const
print "<td align='left' valign='top' id='content'>";
print "<b>"."<font size='5' color='#333333' face='Consolas'>"."New Constitution?"."</font>"."</b>"."<br><br>";
print "<b>".$qA_const."</b>"."<br>"." ".$imgtagA_const." ".$percentA_const. "% "."   "."<br>votes"." ".$answerA_const."<br>"."<br>";
print "<b>".$qB_const."</b>"."<br>"." ".$imgtagB_const." ".$percentB_const. "% "."   "."<br>votes"." ".$answerB_const."<br>"."<br>";
...
<a href='results_asst_coordinator.php' target="_blank">Next</a>
</body>