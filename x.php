<html>
<head>
<title>Project Coordintor</title>
...
<table >
		...
		<tr id="linkbar"><td >Chairperson</td><td>Sec General</a></td><td>Treasurer </a></td><td background="bg1.jpg">Project Coordinator </a></td><td>Asst P.Coordinator </a></td><td>Asst Sec Gen </a></td><td>Constitution </a></td></tr>
...
session_start();
if (!(isset($_SESSION['gatepass_x']) && $_SESSION['gatepass_x'] != '')) {
...
<form name="form1" method="GET" action="process_x.php">
<?php print "<b>"."<font size='5' color='#FF0000'>".$question."</font>"."</b>"; ?>
<br><br>
<table><tr><td valign='top'>
<img src="profile/ALFRED KIPKOECH LANG'AT.jpg" width="150" height="170" align="center" class="pic">
<br><br>
<input class="radiob" type="radio" name="q" value="A" <?PHP print $answerA?>><?PHP print $qA?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<td valign='top'>
<img src="profile/OCHIENG KEVIN.jpg" width="150" height="170" align="center" class="pic">
<br><br>
...
<td valign='top'>
<img src="profile/Akosi Kennedy.jpg" width="150" height="170" align="center" class="pic">
<br><br>
<input class="radiob" class="radiob" type="radio" name="q" value="C" <?PHP print $answerC?>><?PHP print $qC?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
