...
<table >
		...
		<tr id="linkbar"><td >Chairperson</td><td>Sec General</a></td><td background="bg1.jpg">Treasurer </a></td><td>Project Coordinator </a></td><td>Asst P.Coordinator </a></td><td>Asst Sec Gen </a></td><td>Constitution </a></td></tr>
		<tr><td colspan="7" id="qstn"><br>
<?php

session_start();
if (!(isset($_SESSION['gatepass_secretary']) && $_SESSION['gatepass_secretary'] != '')) {
...
<form name="form1" method="GET" action="process_secretary.php">
<?php print "<b>"."<font size='5' color='#FF0000'>".$question."</font>"."</b>"; ?>
<br><br>
<table><tr><td valign='top'>
<img src="profile/NJOROGE DENNIS MBUTHIA.jpg" width="150" height="170" align="center" class="pic">
<br><br>
<input class="radiob" type="radio" name="q" value="A" <?PHP print $answerA?>><?PHP print $qA?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<td valign='top'>
<img src="profile/DICKSON KIPKIRUI LANG'AT.jpg" width="150" height="170" align="center" class="pic">
<br><br>
