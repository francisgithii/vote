...
{
window .location = 'http://www.francis.com/myleader/results_chairman.php' ;
}
...
print "<b>"."<font size='5' color='#333333' face='Consolas'>"."Chairperson"."</font>"."</b>"."<br><br>";
