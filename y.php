<html>
<head>
<title>Asst P.Cooridnator</title>
...
session_start();
if (!(isset($_SESSION['gatepass_y']) && $_SESSION['gatepass_y'] != '')) {
...
<form name="form1" method="GET" action="process_y.php">
<?php print "<b>"."<font size='5' color='#FF0000'>".$question."</font>"."</b>"; ?>
<br><br>
<table><tr><td valign='top'>
<img src="profile/SEBASTIAN KAMUNYA.jpg" width="150" height="170" align="center" class="pic">
<br><br>
...
<td valign='top'>
<img src="profile/JOSEPH KISIA.jpg" width="150" height="170" align="center" class="pic">
<br><br>
