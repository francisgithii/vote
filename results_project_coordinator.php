<html><head>
<title>Results Proj Coordinator</title>
...
{
window .location = 'http://www.francis.com/myleader/results_project_coordinator.php' ;
}
...
/*
print "<td align='left' valign='top' id='content'>";
print "<b>"."<font size='5' color='#333333' face='Consolas'>"."Treasurer"."</font>"."</b>"."<br>";
...
print "<td align='left' valign='top' id='content'>";
print "<b>"."<font size='5' color='#333333' face='Consolas'>"."Project Coordinator"."</font>"."</b>"."<br><br>";
...
<a href='results_treasurer.php' target="_blank">Next</a>
</body>